...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-11-2025 a las 23:22:09
...
CREATE TABLE `audit_log` (
  ...
  `sql_ejecutado` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `sql_rollback` text COLLATE utf8mb4_unicode_ci,
  `ip_cliente` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(46, 'admin', 'BACKUP_CREATE', 'SYSTEM', 0, 'GENERATED JSON BACKUP: backup-1763423128973.json', 'CANNOT ROLLBACK FILE CREATION', '::ffff:192.168.0.100', '2025-11-17 06:45:29'),
(60, 'admin', 'BACKUP_CREATE', 'SYSTEM', 0, 'GENERATED JSON BACKUP: backup-1763430951906.json', 'CANNOT ROLLBACK FILE CREATION', '::ffff:192.168.0.100', '2025-11-17 08:55:51'),
(61, 'admin', 'BACKUP_DOWNLOAD', 'SYSTEM', 0, 'DOWNLOAD JSON BACKUP: backup-1763430951906.json', 'CANNOT ROLLBACK DOWNLOAD OPERATION', '::ffff:192.168.0.100', '2025-11-17 09:17:08'),
(62, 'admin', 'INSERT', 'Vehicle/ParkingSession', 929608, 'INSERT INTO Vehicle (id, plateNumber, vehicleType, status, entryTime) VALUES (\"929608d5-c4b0-11f0-b0ee-7427eaf2ac34\",\"ABC123\",\"CAR\",\"PARKED\",\"2025-11-18 13:58:30\"); ', 'DELETE FROM Vehicle WHERE id=\"929608d5-c4b0-11f0-b0ee-7427eaf2ac34\"; DELETE FROM ParkingSession WHERE vehicleId=\"929608d5-c4b0-11f0-b0ee-7427eaf2ac34\"; UPDATE ParkingCapacity SET currentCount = currentCount - 1 WHERE vehicleType=\"CAR\";', 'localhost', '2025-11-18 18:58:30'),
(63, 'admin', 'UPDATE', 'Vehicle/ParkingSession', 929608, 'UPDATE Vehicle SET exitTime=\"2025-11-18 14:00:44\", status=\"EXITED\", totalAmount=20.00 WHERE id=\"929608d5-c4b0-11f0-b0ee-7427eaf2ac34\"; UPDATE ParkingSession SET exitTime=\"2025-11-18 14:00:44\", duration=2, amount=20.00, status=\"COMPLETED\" WHERE vehicleId=\"929608d5-c4b0-11f0-b0ee-7427eaf2ac34\"; UPDATE ParkingCapacity SET currentCount=currentCount-1 WHERE vehicleType=\"CAR\";', 'UPDATE Vehicle SET exitTime=NULL, status=\"PARKED\", totalAmount=NULL WHERE id=\"929608d5-c4b0-11f0-b0ee-7427eaf2ac34\"; UPDATE ParkingSession SET exitTime=NULL, duration=NULL, amount=NULL, status=\"ACTIVE\" WHERE vehicleId=\"929608d5-c4b0-11f0-b0ee-7427eaf2ac34\"; UPDATE ParkingCapacity SET currentCount=currentCount+1 WHERE vehicleType=\"CAR\";', 'localhost', '2025-11-18 19:00:44');
...
('290604b0-c1ad-11f0-9387-7427eaf2ac34', 'CAR', 50, 0, '2025-11-18 14:00:44'),
...
('92962dd0-c4b0-11f0-b0ee-7427eaf2ac34', '929608d5-c4b0-11f0-b0ee-7427eaf2ac34', 'ABC123', 'CAR', '2025-11-18 13:58:30', '2025-11-18 14:00:44', 2, 20.00, 'COMPLETED', '2025-11-18 13:58:30', '2025-11-18 14:00:44'),
...
CREATE TABLE `vehicle` (
  ...
  `exitTime` datetime DEFAULT NULL,
  `status` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'PARKED',
...
('929608d5-c4b0-11f0-b0ee-7427eaf2ac34', 'ABC123', 'CAR', '2025-11-18 13:58:30', '2025-11-18 14:00:44', 'EXITED', 20.00, '2025-11-18 13:58:30', '2025-11-18 14:00:44'),
